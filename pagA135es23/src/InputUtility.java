...
public class InputUtility {
    ...
    public static int controlloInputArchivio(int input, int min, int max){
        while(input < min || input > max){
            InputUtility.inputInteger("Il numero inserito non è valido, inserire un numero compreso tra" + min + "e" + max);
        }
